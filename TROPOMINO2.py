...
def DailyTROPOMINO2():
    ...
    date = col01.date_input("Enter Date:", current, max_value=current, min_value = datetime.date(2025,1,1))
...
def DailyTROPOMINO2():
    ...
    if (seasonal_input=='Winter'):
        ...
        if year_input in ['2019', '2020']:
            ...
            col12.image(f"./seasonal/DJF_{year_input}_TROPOMI_QA75.png", use_column_width = True, caption = f"TROPOMI NO2 {seasonal_input}(Dec-Feb) {year_input}")
        else:
            ...
            col15.image(f"./seasonal/DJF_{year_input}_TROPOMI_QA75.png", use_column_width= True, caption=f"TROPOMI NO2 {seasonal_input}(Dec-Feb) {year_input}")
            col16.image(f"./seasonal/DJF_{year_input}_vs_baseline_TROPOMI_diff.png", use_column_width= True, caption=f"Difference between selected timeframe and baseline period")
        ...
        if year_input in ['2018', '2019']:
            ...
            col12.image(f"./seasonal/JJA_{year_input}_TROPOMI_QA75.png", use_column_width = True, caption = f"TROPOMI NO2 {seasonal_input}(Jun-Aug) {year_input}")
